...
def make_parser():
    ...
    inspect = subparsers.add_parser(
        'inspect', description="Inspect an NEO by primary designation"
                               " or by name.")
...
def inspect(database, pdes=None, name=None, verbose=False):
    ...
    `verbose=True`). Otherwise, a message is printed noting that
    there are no matching NEOs.
...
class NEOShell(cmd.Cmd):
    ...
    inspect and query commands, while only loading the data
    ...
    def do_query(self, arg):
        ...
        the command line.
        For example, to query close approaches on January 1st, 2020:
    ...
    def precmd(self, line):
        ...
        if changed:
            ...
            if not self.aggressive:
                print(
                    "To include these changes, please exit and restart "
